...
public abstract class Fish implements Serializable{
    ...
    private transient ArrayList<Gain> gainList = new ArrayList<>();
    public  Gain newGain;
...
//        if(animationIndex==6){animationIndex=0;}
    ...
    public boolean isPlayer(){
        return Client.SESION_ID==playerID;
    }
    //Add/Give
                ...
                if(speedX==0){
                    if(facingLeft){
                        g2.drawImage(swimToLeft[animationIndex], (int)drawX, (int)drawY, 
                            (int) (swimToLeft[animationIndex].getWidth()*Camera.getZoom()), 
                            (int) (swimToLeft[animationIndex].getHeight()*Camera.getZoom()), null);
                    }else{
                        g2.drawImage(swimToRight[animationIndex], (int)drawX, (int)drawY, 
                            (int) (swimToRight[animationIndex].getWidth()*Camera.getZoom()), 
                            (int) (swimToRight[animationIndex].getHeight()*Camera.getZoom()), null);
                    }
                }else if(speedX>0){
                    g2.drawImage(swimToRight[animationIndex], (int)drawX, (int)drawY, 
                            (int) (swimToRight[animationIndex].getWidth()*Camera.getZoom()), 
            ...
            //Rest
                ...
                if(facingLeft){
                    ...
                    g.drawImage(restFacingRight[animationIndex], (int)drawX, (int)drawY, 
                            (int) (restFacingRight[animationIndex].getWidth()*Camera.getZoom()), 
                            (int) (restFacingRight[animationIndex].getHeight()*Camera.getZoom()), null);
                }
            }
            //ShowGain
