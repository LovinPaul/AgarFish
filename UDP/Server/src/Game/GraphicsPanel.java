...
//    private static BufferedImage dumbGreenFishSwimRight[];
    ...
    private static BufferedImage sprintBubble;
...
//        dumbGreenFishSwimRight = new BufferedImage[6];
        ...
        try {
            ...
            background[0] = ImageIO.read(new File("Data\\Background\\background2.png"));            
            ...
            err = "Fish\\sprint\\Bubble\\1.png";
            sprintBubble = ImageIO.read(new File("Data\\Fish\\sprint\\Bubble\\1.png"));
...
//    }
    ...
    public static BufferedImage getSprintBubles(){
        return sprintBubble;
    } 
