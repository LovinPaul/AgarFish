...
public abstract class Camera {
    ...
    private static boolean moveX;
     static int agilityX=100;
     static int agilityY=100;
...
//    }
    ...
    public static void updateCoord(){
        ...
        if(x<1){x=1;}
        if(y<1){y=1;}
        if(x>(GraphicsPanel.getBackground()[0].getWidth()-Server.getWIDTH())){x=(GraphicsPanel.getBackground()[0].getWidth()-Server.getWIDTH());}
